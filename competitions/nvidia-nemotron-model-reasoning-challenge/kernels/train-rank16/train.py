...
def run_training(rank: int, alpha: int, smoke: bool = False, data_path: str = None):
...
if __name__ == "__main__":
    ...
    run_training(rank=args.rank, alpha=args.alpha, smoke=args.smoke, data_path=args.data)
