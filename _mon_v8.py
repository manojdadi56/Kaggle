...
prev=None
for i in range(120):  # up to 240 min
...
for l in full.splitlines():
    if any(k in l for k in ["GPU","RTX","T4","sm_","trainable","loaded","step ","Training done","adapter r","CV ","Saving","submission.zip","Error","Found no","installing","Loading","INCOMPATIBLE"]):
