...
prev=None
for i in range(140):  # up to 280 min
...
for l in full.splitlines():
    if any(k in l for k in ["GPU","RTX","T4","sm_","trainable","loaded","step ","Training done","adapter r","CV ","Saving","submission.zip","Error","installing","Loading","INCOMPATIBLE","bitsandbytes","MODEL_PATH"]):
