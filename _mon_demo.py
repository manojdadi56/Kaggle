...
prev=None
for i in range(150):  # up to 300 min
    try:
...
for l in full.splitlines():
    if any(k in l for k in ["GPU0","RTX","T4","P100","sm_","trainable","loaded","step ","Training done","adapter r","CV ","Saving adapter","submission.zip","Error","Found no"]):
